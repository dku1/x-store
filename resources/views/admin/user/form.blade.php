...
@section('content')
    <x-admin.content-header>
        ...
        <x-slot:breadcrumbs>
            ...
            <li class="breadcrumb-item">
                <a class="text-primary" href="{{ route('admin.users.index') }}">{{ __('admin.users.users') }}</a>
            </li>
            <li class="breadcrumb-item">
    ...
    <div class="col-8 m-auto">
        <form class="row g-3"
            ...
            <div class="col-md-5">
                ...
                <input type="text" class="form-control" name="first_name" placeholder="Александр"
            ...
            <div class="col-md-5">
                ...
                <input type="text" class="form-control" name="last_name" placeholder="Невский"
                       value="{{ old('last_name') }}">
            </div>
