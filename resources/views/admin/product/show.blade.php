...
@section('content')
    <x-admin.content-header>
        ...
        <x-slot:breadcrumbs>
            ...
            <li class="breadcrumb-item">
                <a class="text-primary" href="{{ route('admin.products.index') }}">{{ __('main.menu.products') }}</a>
            </li>
            <li class="breadcrumb-item">
                <a class="text-secondary" href="#">{{ $product->getField('title') }}</a>
            </li>
        </x-slot:breadcrumbs>
    </x-admin.content-header>
