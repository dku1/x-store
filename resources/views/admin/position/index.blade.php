...
@section('content')
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary"
                                                       href="#"
                                                       style="pointer-events: none">{{ __('main.menu.positions') }}</a>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    @if($positions->count() != 0)
        <div class="col-9 m-auto p-1">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                      {{ __('admin.count_positions') }} : {{ $positions->total() }}
                    </h3>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($positions as $position)
                            <tr>
                                ...
                                <th scope="row" class="text-center"><img src="{{ asset('storage/' . $position->image) }}"
                                                     alt="Изображение отсутствует" width="150px" height="180px"></th>
