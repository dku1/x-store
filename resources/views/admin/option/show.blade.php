    ...
    <x-admin.content-header>
        ...
        <x-slot:breadcrumbs>
            ...
            <li class="breadcrumb-item">
                <a class="text-primary" href="{{ route('admin.options.index') }}">{{ __('admin.options') }}</a>
            </li>
            <li class="breadcrumb-item">
                <a class="text-secondary" href="#" style="pointer-events: none">{{ $option->getField('title') }}</a>
            </li>
        </x-slot:breadcrumbs>
    </x-admin.content-header>
