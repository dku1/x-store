                ...
                <div class="col-md-5 col-lg-4 order-md-last">
                    ...
                    <ul class="list-group mb-3">
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            <div>
                                <h6 class="my-0"><a class="text-dark text-decoration-none" href="{{ route('products.show', $product) }}">{{ $product->getField('title') }}</a></h6>
                                <small class="text-muted">Кол-во: {{ $product->pivot->quantity }}</small>
                            </div>
                            <span class="text-muted">{{ $cart->getFullProductPrice($product) }} {{ $currentCurrency->symbol }}</span>
                        </li>
                        @endforeach
                    ...
                    <form class="needs-validation" novalidate="">
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" placeholder="Александр" value="" name="first_name">
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="address" placeholder="Партизанская д.82, кв.70">
                            </div>
