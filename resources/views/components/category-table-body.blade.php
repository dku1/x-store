@foreach($categories as $category)
    ...
    @if($category->childrenExist())
        <tr class="expandable-body d-none">
            <td colspan="5">
                <div style="display: none;">
                    <h4 class="p-2">{{ __('admin.categories.subcategories_for') }} {{ $category->getField('title') }}</h4>
                    <table style="width: 100%">
                        <x-category-table-body :categories="$category->children"/>
                    </table>
                </div>
            </td>
        </tr>
